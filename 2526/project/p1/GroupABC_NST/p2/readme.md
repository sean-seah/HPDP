...
```bash
python src/benchmark_crawler.py
```
...
## Output
The main outputs of Part 2 are:
...
## Notes
This folder is for Part 2 evaluation and optimization results. The raw and cleaned crawler datasets are stored in the `p1/` folder.
